...
fixed_SystemPrompt = [
                    ...
                    {"role": "system", "content": "如果[]里的内容为空必须表明截止到目前你没有学习或训练过这方面的知识的意思，并表明你的专长。"},
               ]


ToolPrompt=f"根据以下中括号内容：[knowledge]，详细回答以下小括号的问题：(question)。如果[]里的内容为空，则向用户表达出截止到当前时间你没有学习或训练过这方面的知识。"
