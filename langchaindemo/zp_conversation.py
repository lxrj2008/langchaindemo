...
os.environ["OPENAI_API_KEY"] = cfg.ONLINE_LLM_MODEL["ZHIPU"]["api_key"]
os.environ["OPENAI_BASE_URL"] = cfg.ONLINE_LLM_MODEL["ZHIPU"]["api_base_url"]
    ...
    def ask(self,question):
        try:
            ...
            response = client.chat.completions.create(
                model=cfg.ONLINE_LLM_MODEL["ZHIPU"]["model_name"],
